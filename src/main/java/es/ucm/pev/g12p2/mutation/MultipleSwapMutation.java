 ...
 * @author Herros Team
 */
public class MultipleSwapMutation extends Mutation{

    public MultipleSwapMutation(double probabilityOfMutation, int populationSize) {
    ...
    public Chromosome swap(Chromosome c){
        int numSwaps = ThreadLocalRandom.current().nextInt(0, c.getLength());
